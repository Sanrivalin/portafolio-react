    ...
    resources : {
        en : {
            translation : {
                ...
                heroParagraph: "Experienced web developer fluent in English, specializing in user-focused web design for E-commerce and digital services. Proficient in HTML, CSS, JavaScript, PHP, WooCommerce, and Vtex. Skilled troubleshooter with 4 years of cross-functional project development experience and strong customer service skills.",
                ...
                projectsTitle5: "Encryptor and Decryptor Game",
                projectsTitle6: "'ShopCart' Web Application",
        ...
        es : {
            translation : {
                ...
                heroParagraph: "Desarrollador web experimentado, fluido en inglés, especializado en diseño web centrado en el usuario para comercio electrónico y servicios digitales. Experto en HTML, CSS, JavaScript, PHP, WooCommerce y Vtex. Habilidoso solucionador de problemas con 4 años de experiencia en desarrollo de proyectos interfuncionales y sólidas habilidades de servicio al cliente",
